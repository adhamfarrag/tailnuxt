<template>
  <div class="flex flex-row justify-between px-3 py-4 border-b border-gray-200">
    <div class="flex flex-row items-center justify-start ml-24">
      <div id="logo">
        <nuxt-link to="/CoinHome">
          <svg
            fill="currentColor"
            role="button"
            class="w-24 text-logo-coinbase"
      ...
      <div class="mt-1 ml-20 text-sm font-medium">
        <nuxt-link to="/CoinHome" class="py-5 text-black header_nav_link hover:text-logo-coinbase"
          >Home</nuxt-link
        >
        <nuxt-link to="/CoinPrices" class="ml-8 text-black header_nav_link hover:text-logo-coinbase"
          >Prices</nuxt-link
        >
        <nuxt-link
          to="/CoinAccounts"
          class="ml-8 text-black header_nav_link hover:text-logo-coinbase"
          >Accounts</nuxt-link
        >
      </div>
    </div>
