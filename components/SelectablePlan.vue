<template>
  <div class="flex flex-wrap justify-between py-8 mx-auto w-custom">
    <div
      class="w-48 p-6 mb-8 bg-white rounded-lg shadow-md cursor-pointer hover:bg-green-300 focus:outline-none focus:shadow-outline-green"
      :class="{ 'bg-green-200 shadow-outline-green': this.activePlan === this.planName }"
      tabindex="0"
      @click="updateActivePlan"
      @keydown.space="updateActivePlan"
    >
      <div class="flex items-center justify-between mb-3">
        <h1 class="text-base tracking-wide text-blue-800 uppercase">{{ this.planName }}</h1>
      ...
      <div class="mb-1 font-semibold text-blue-darker">
        <span class="mr-2 text-5xl">{{ this.planGigs }}</span>
      ...
      <div>
        ...
        <span class="mx-1 text-blue-alternate">/</span>
